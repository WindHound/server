...
public class DBEvent
{
    ...
    public static Long saveOrUpdateEvent(Connection connection, Event event)
    {
        ...
        LocalDateTime startDatetime = LocalDateTime.ofInstant(event.getStartDate(), ZoneOffset.UTC);
        LocalDateTime endDatetime   = LocalDateTime.ofInstant(event.getEndDate(), ZoneOffset.UTC);
