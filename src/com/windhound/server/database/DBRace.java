...
public class DBRace
{
    ...
    public static Long saveOrUpdateRace(Connection connection, Race race)
    {
        ...
        LocalDateTime startDatetime = LocalDateTime.ofInstant(race.getStartDate(), ZoneOffset.UTC);
        LocalDateTime endDatetime   = LocalDateTime.ofInstant(race.getEndDate(), ZoneOffset.UTC);
